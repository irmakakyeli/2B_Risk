 ...
 * 
 */
@WebServiceClient(name = "GameEngineService", targetNamespace = "http://simpleworldgame.cs.bilkent.edu/", wsdlLocation = "http://localhost:8080/SimpleWorldGame/GameEngineService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/SimpleWorldGame/GameEngineService?wsdl");
