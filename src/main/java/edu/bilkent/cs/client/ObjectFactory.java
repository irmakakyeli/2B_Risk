 ...
 * generated in the edu.bilkent.cs.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _ActivatePLayer_QNAME = new QName("http://risk.cs.bilkent.edu/", "activatePLayer");
    private final static QName _ActivatePLayerResponse_QNAME = new QName("http://risk.cs.bilkent.edu/", "activatePLayerResponse");
    private final static QName _GetPLayers_QNAME = new QName("http://risk.cs.bilkent.edu/", "getPLayers");
    private final static QName _GetPLayersResponse_QNAME = new QName("http://risk.cs.bilkent.edu/", "getPLayersResponse");
    private final static QName _RegisterPLayer_QNAME = new QName("http://risk.cs.bilkent.edu/", "registerPLayer");
    private final static QName _RegisterPLayerResponse_QNAME = new QName("http://risk.cs.bilkent.edu/", "registerPLayerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.bilkent.cs.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "activatePLayer")
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "activatePLayerResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "getPLayers")
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "getPLayersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "registerPLayer")
     ...
     */
    @XmlElementDecl(namespace = "http://risk.cs.bilkent.edu/", name = "registerPLayerResponse")
